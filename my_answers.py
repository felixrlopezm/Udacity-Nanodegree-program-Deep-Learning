...
# REVISED DATE:
# PURPOSE: MPL neural network call from Jupyter Notebook
#          "Predicting_bike_sharing_data.ipynb"
#         Built as part of the Bike Sharing project of the Udacity Nanodegree
...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        output_error_term = error  # activation function is identity function, so derivative is 1
    ...
    def update_weights(self, delta_weights_i_h, delta_weights_h_o, n_records):
        ...
        '''
        self.weights_hidden_to_output += delta_weights_h_o / n_records # update h2o weights with gradient descent step
        self.weights_input_to_hidden += delta_weights_i_h / n_records # update i2h weights with gradient descent step
